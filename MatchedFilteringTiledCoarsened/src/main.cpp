...
int main(int argc, char **argv)
{
	...
	std::ifstream file("/home/axs4549/PulseCompress-CUDA-Matched-Filtering/MatchedFilteringTiledCoarsened/src/signal.bin", std::ios::binary);
	if (!file.is_open())
	{
	...
	std::ifstream file1("/home/axs4549/PulseCompress-CUDA-Matched-Filtering/MatchedFilteringTiledCoarsened/src/filter.bin", std::ios::binary);
	if (!file1.is_open())
	{
	...
	file1.close();
	float *result = new float[SIG_SIZE - FILTER_SIZE + 1];
	...
	std::ofstream outFile("/home/axs4549/PulseCompress-CUDA-Matched-Filtering/MatchedFilteringTiledCoarsened/src/output.bin", std::ios::binary);
	...
	outFile.write(reinterpret_cast<char*>(result), (SIG_SIZE - FILTER_SIZE + 1) * sizeof(float));	
	outFile.close();
